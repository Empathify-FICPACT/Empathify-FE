    ...
    <div className="bg-[rgba(245,245,245,1)]">
      ...
      <section className="bg-[#25B868] px-[30px] py-16 flex items-center justify-between relative overflow-hidden">
        ...
        <div className="max-w-xl ml-25">
          <h1 className="text-4xl font-bold leading-tight text-[rgba(255,255,255,1)] font-[Nunito]">
            Temani Perjalanan Belajar Anak Bersama Empathify
          </h1>
        </div>

        {/* IMAGE */}
        <div className="absolute right-[140px] bottom-[-45px] w-[400px] h-[290px]">

          {/* BACK IMAGE */}
          <div className="absolute left-[150px] bottom-[10px] w-[390px] h-[290px] z-0">
            <Image
              src="/animjudul2.png"
              alt="bg"
              fill
      ...
      {/* TENTANG */}
      <section className="px-30 py-16 max-w-6xl mx-auto flex items-center justify-between gap-10">

        {/* TEXT */}
        <div className="max-w-2xl">
          <h2 className="text-[30px] font-extrabold text-[rgba(37,184,104,1)] font-[Nunito] mb-4">
            Tentang Empathify
          </h2>

          <p className="text-[15px] font-medium text-[rgba(119,119,119,1)] font-[Nunito] text-justify">
        ...
        {/* IMAGE */}
        <div className="w-[180px] h-[180px] right-[10] relative">
          <Image
            src="/anim2.png"
            alt="tentang"
            fill
      ...
      {/* MISI */}
      <section className="px-30 py-1 max-w-6xl mx-auto">

        {/* TITLE */}
        <div className="space-y-10">
          <h2 className="text-[30px] font-extrabold text-[rgba(37,184,104,1)] font-[Nunito] mb-10">
            Misi Kami
          </h2>
          ...
          {/* Item 1 */}
          <div className="flex items-center justify-center gap-20 pb-6 border-b border-[rgba(220,220,220,1)]">
            <Image src="/anim1.png" alt="anim" width={180} height={180} />

            <div className="max-w-xl space-y-3">
              <h3 className="text-[20px] font-[Nunito] text-[rgba(60,60,60,1)] font-bold">
          ...
          {/* Item 2 */}
          <div className="flex items-center justify-center flex-row-reverse gap-20 pb-6 border-b border-[rgba(220,220,220,1)]">
            <Image src="/anim1.png" alt="anim" width={180} height={180} />
      ...
      {/* TEAM */}
      <section className="px-[120px] py-0 mt-16 max-w-6xl mx-auto">

        {/* TITLE */}
        <div className="space-y-15">
          <h2 className="text-[30px] font-extrabold text-[rgba(37,184,104,1)] font-[Nunito]">
            Profil Tim
          </h2>
