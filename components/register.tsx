    ...
    >
      ...
      <div className="relative z-10 w-[92%] max-w-[340px] sm:max-w-[450px] md:max-w-[470px] bg-white rounded-2xl p-6 sm:p-10 shadow-xl mx-auto mt-12 sm:mt-16 md:mt-0">
          ...
          <div className="flex items-center justify-between text-xs sm:text-sm mt-1 pb-1">
            <label className="flex items-center gap-2 cursor-pointer group">
              <div className="relative flex items-center">
                ...
                />
                <svg className="absolute w-3 h-3 text-white left-0.5 top-0.5 opacity-0 peer-checked:opacity-100 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="20 6 9 17 4 12"></polyline>
                </svg>
              </div>
              <span className="text-gray-400 group-hover:text-gray-600 transition font-medium">Saya menyetuji Syarat & Ketentuan yang berlaku</span>
            </label>
          </div>
        ...
        <p className="text-center text-[10px] sm:text-[11px] md:text-xs text-gray-400 leading-relaxed max-w-[95%] mx-auto mt-4 sm:mt-0">
          Dengan masuk, kamu menyetujui <a href="#" className="font-semibold text-gray-500 hover:text-gray-700 hover:underline">Kebijakan Privasi</a> dan <a href="#" className="font-semibold text-gray-500 hover:text-gray-700 hover:underline">Syarat & Ketentuan</a> Empathify.
        </p>
      </div>
    </div>
  );
