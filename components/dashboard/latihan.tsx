      ...
      <div className="flex flex-col xl:flex-row gap-6 lg:gap-8 items-start relative">
        ...
        <div className="flex-1 w-full order-2 xl:order-1 min-w-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
            ...
            {/* Card 1 - Green */}
            <div className="bg-[#3FC07B] rounded-[20px] lg:rounded-[24px] p-4 sm:p-5 lg:p-6 text-white flex flex-col justify-between  min-h-[150px] sm:min-h-[180px] lg:min-h-[255px] shadow-sm hover:scale-[1.02] transition-transform duration-300 relative overflow-hidden">
              ...
              <button className="flex items-center gap-1.5 text-white font-semibold text-xs sm:text-sm lg:text-lg mt-2 z-10 relative">
                Mulai Latihan
            ...
            {/* Card 4 - Orange */}
            <div className="bg-[#F4B803] rounded-[20px] lg:rounded-[24px] p-4 sm:p-5 lg:p-6 text-white flex flex-col justify-between min-h-[150px] sm:min-h-[180px] lg:min-h-[255px] shadow-sm hover:scale-[1.02] transition-transform duration-300 relative overflow-hidden">
              <div className="z-10 relative max-w-[65%] mt-2">
                <h2 className="text-lg lg:text-2xl font-bold lg:leading-relaxed mb-1">
                  Cerita Interaktif
                </h2>
